...
Дата: ${new Date().toLocaleString('ru-RU')}
      ...
      a.href = url;
      a.download = `prothetic-report-${user?.email || 'user'}-${new Date().toISOString().split('T')[0]}.txt`;
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        <div className="p-8 bg-white rounded-lg shadow-md text-center max-w-md w-full">
          ...
          <p className="text-gray-600 mb-6">Войдите в систему для доступа к отчетам</p>
